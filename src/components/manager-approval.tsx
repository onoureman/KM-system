...
export function ManagerApproval({
  ...
  const pendingArticles = articles.filter(article => article.status === 'pending_manager');
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                {pendingArticles.length} case{pendingArticles.length !== 1 ? 's' : ''} pending your approval
              </p>
            </div>
          ...
          {pendingArticles.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                All cases have been reviewed. New submissions will appear here.
              </p>
            </div>
          ) : (
      ...
      <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
        <DialogContent className="bg-card border-white/10">
          <DialogHeader>
            ...
            <DialogDescription>
              Provide a reason for rejecting this case. The author will be notified.
            </DialogDescription>
          </DialogHeader>
